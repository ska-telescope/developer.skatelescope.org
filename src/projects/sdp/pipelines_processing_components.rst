Workflows/Pipelines and Processing Components
---------------------------------------------
...
- `More details can be found here <https://developer.skatelescope.org/projects/ska-sdp-workflow/en/latest/index.html>`_
...
`here <https://developer.skatelescope.org/projects/ska-sdp-science-pipelines/en/latest/index.html>`_
