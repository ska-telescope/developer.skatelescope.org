...
The SDP is part of the evolutionary prototype of the SKA software. The SDP is built from software modules which produce a number of different types of artefacts.
