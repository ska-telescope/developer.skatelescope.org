...
def setup(app):
    ...
    app.add_js_file('js/utils.js', loading_method="defer")
    app.add_js_file('js/areas_lists.js', loading_method="defer")
    app.add_js_file('js/project_lists.js', loading_method="defer")
