...
environments can be provisioned: see `Testing Skampi <https://developer.skao.int/projects/skampi/en/latest/testing.html#testing-skampi>`_.
...
See additional details on `Pytest configuration <https://developer.skao.int/projects/skampi/en/latest/testing.html#pytest-configuration>`_.
