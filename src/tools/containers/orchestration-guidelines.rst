...
.. warning:: **Helm 2 vs Helm 3**
  ...
  It should be noted that we have now migrated to using Helm 3. Feel free to upgrade Helm in your development environments using our Ansible Playbook ``upgrade_helm.yml`` found in the `SKA Ansible Playbooks repository <https://developer.skao.int/projects/ansible-playbooks/en/latest/playbooks/upgrade_helm.html>`_.
